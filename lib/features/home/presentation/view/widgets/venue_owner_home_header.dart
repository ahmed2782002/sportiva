...
class VenueOwnerHomeHeader extends StatelessWidget {
  const VenueOwnerHomeHeader({super.key});
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      ...
                      const Color(0xFF1E4D09).withValues(alpha: 0.0),
                    ],
                  ),
                ),
              ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      const Color(0xFF69F0AE).withValues(alpha: 0.18),
                      Colors.transparent,
                    ],
                  ),
                ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppString.venueOwnerGreeting.tr(),
                    style: TextStyle(
                      color: AppColors.white,
                      fontSize: 22.sp,
                      fontWeight: FontWeight.w800,
