                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      ...
                      const Color(0xFF8A246B).withValues(alpha: 0.0),
                    ],
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.bolt_rounded, color: const Color(0xFFFFD700), size: 16.sp),
                        SizedBox(width: 6.w),
                        Text(
                          AppString.homeSubtitle.tr(),
                          style: TextStyle(
                            color: AppColors.white,
                            fontSize: 12.sp,
